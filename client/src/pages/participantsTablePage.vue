<template>
  ...
  <div style="max-height: 90dvh; overflow: auto;">
    ...
    <q-page-sticky v-if="userStore.hasAccess('ADD_PARTICIPANT')" position="bottom-right" :offset="fabpos"
...
<script setup>
import ParticipantTableComponent from 'src/components/ParticipantTableComponent.vue'
